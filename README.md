...
This is a conversational bot for Microsoft Teams that demonstrates how you could build a DevOps bot with additional functionally of creating order in SQL. The bot uses the gpt-4 model to chat with Teams users and perform DevOps action such as create, update, triage and summarize work items.
...
1. Clone the repository
    ...
    ```bash
    git clone https://github.com/ReenuSaluja/CEA-quickDemo.git
    ```
